...
const HowItWorks = () => {
  const { isBigScreen, isMobileOrTablet, isLaptopOrTablet, isMobile } =
    useDashboard();
      ...
      {isMobileOrTablet && (
        <div className={s.swiper_wrapper}>
          <Swiper
            ...
            centeredSlides={isLaptopOrTablet ? false : true}
          >
          ...
          <li>
            <div className={s.step_wrapper}>
              ...
              <div className={s.step}>
                ...
                <h3 className={s.step_title}>Add accessories that you need</h3>
                <p className={s.step_text}>
                  Camera/battery/scanner/ workstation etc.
                </p>
              </div>
